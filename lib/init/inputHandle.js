...
exports.default = (function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
    var config, targetPath, rootPath, compareOrigin, compareOriginFile, _a, _b, _c, lackTemplate, extraTemplate, allTemplate, extname, ignoreDir, output;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                config = ctx.config;
                return [4 /*yield*/, common_1.getPath(config.target)];
            case 1:
                targetPath = _d.sent();
                rootPath = path_1.default.parse(targetPath).base;
                if (!config.compare) return [3 /*break*/, 6];
                _a = babelTraverse_1.traverseFileToObj;
                _b = common_1.readFile;
                return [4 /*yield*/, common_1.getPath(config.compare)];
            case 2: return [4 /*yield*/, _b.apply(void 0, [_d.sent()])];
            case 3:
                compareOrigin = _a.apply(void 0, [_d.sent()]);
                _c = common_1.readFile;
                return [4 /*yield*/, common_1.getPath(config.compare)];
            case 4: return [4 /*yield*/, _c.apply(void 0, [_d.sent()])];
            case 5:
                // compareOrigin = require( await getPath(config.compare))
                compareOriginFile = _d.sent();
                _d.label = 6;
            case 6:
                lackTemplate = "\n  // \u539F\u6587\u4EF6\u7F3A\u5C11\u7684\u90E8\u5206\n  const lack = {};\n  ";
                extraTemplate = "\n  // \u539F\u6587\u4EF6\u591A\u51FA\u7684\u90E8\u5206\n  const extra = {};\n  ";
